...
const palBtn = document.getElementById("palBtn"),
  palMenu = document.getElementById("palMenu");
function setPalette(p) {
  if (!PALS.includes(p)) p = "indigo";
  root.setAttribute("data-palette", p);
  store.set("palette", p);
  palMenu
    .querySelectorAll(".pal-opt")
    .forEach((o) => o.setAttribute("aria-checked", o.dataset.pal === p));
}
...
palMenu.querySelectorAll(".pal-opt").forEach((o) =>
...
document.addEventListener("click", (e) => {
  if (!palMenu.contains(e.target) && e.target !== palBtn) {
    palMenu.classList.remove("open");
    palBtn.setAttribute("aria-expanded", false);
  }
});
...
const dict = {
  es: {
    nav_xp: "Trabajo destacado",
    nav_serv: "Servicios",
    nav_about: "Sobre mí",
    nav_cta: "Hablemos",
    pal_title: "// paleta",
    aria_pal: "Cambiar paleta de color",
    ...
    hero_lead:
      "Soy Oscar Martínez, ingeniero de software senior con más de 8 años construyendo apps web y móviles usadas por millones —Spin by OXXO, Aeroméxico—. Especializado en React Native, React, Node.js, .NET, AWS y flujos potenciados con IA, ayudo a empresas a llevar su producto de la idea a producción.",
    hero_cta1: "Hablemos de tu proyecto →",
    hero_cta2: "Ver experiencia",
    meta1: "años de experiencia",
    meta2b: "Millones",
    meta2: "de usuarios alcanzados",
    meta3: "móvil · web · cloud · IA",
    exp_eyebrow: "// trabajo destacado",
    exp_head: "Productos que he ayudado a construir.",
    xp_via: "vía",
    tab_biz: "Negocio",
    tab_tech: "Técnico",
    xp1_when: "2025 — 2026",
    ...
    xp1_tech:
      "React Native con TypeScript, integrando microservicios y APIs de backend en una arquitectura distribuida. Estándares estrictos de código, optimización de rendimiento y arquitectura limpia de nivel enterprise.",
    xp2_when: "2025 · Freelance",
    xp2_biz:
      "Una empresa de contratistas manejaba toda su operación en hojas de cálculo — ciudades, materiales y medidores, dispersos y a mano. Les construí un ERP a medida desde cero que lo centraliza todo, para que su equipo deje de perder horas en seguimiento manual y trabaje desde una sola fuente de verdad.",
    xp2_tech:
      "Backend .NET 7 con SQL Server y una PWA React mobile-first (Tailwind). Autenticación JWT, almacenamiento en AWS S3 y módulos de administración para ciudades, materiales y medidores. Desplegado en QA y producción en Ubuntu con Nginx, HTTPS (Let's Encrypt) y pipelines CI/CD.",
    xp3_when: "2023 — 2025",
    xp3_biz:
      "Spin Premia y Spin by OXXO son apps fintech usadas por millones en México — lealtad, pagos y recompensas. Ayudé a construir y mantener las funciones que mantienen esas apps confiables para una base de usuarios enorme.",
    xp3_tech:
      "React Native, Redux y TypeScript, con TDD en Jest y 85%+ de cobertura por pull request. Releases de QA y producción gestionados con Firebase, bajo SCRUM.",
    xp4_when: "2021 — 2023",
    xp4_biz:
      "Para Sumitomo Corporation, una empresa global, ayudé a entregar aplicaciones web internas que agilizan cómo trabajan sus equipos — construidas 100% en remoto junto a stakeholders de EE. UU.",
    xp4_tech:
      "React, Redux, TypeScript y DevExpress en el front, servicios en SQL Server en el back, con TDD en Jest. Desplegado en Microsoft Azure, colaborando en equipos ágiles a través de zonas horarias.",
    xp5_when: "2019 — 2021",
    xp5_biz:
      "Terminal Logistics mueve grandes volúmenes de carga, y su operación corre sobre software a medida. Lideré el desarrollo de las herramientas logísticas que mantienen ese flujo funcionando, día tras día.",
    xp5_tech:
      "React, React Native, Redux, Node.js y C#/.NET, gestionando bases de datos SQL Server y MongoDB pensadas para operaciones logísticas de alto volumen.",
    serv_eyebrow: "// qué construyo",
  ...
  en: {
    nav_xp: "Selected work",
    nav_serv: "Services",
    nav_about: "About",
    nav_cta: "Let's talk",
    pal_title: "// palette",
    aria_pal: "Change color palette",
    ...
    hero_lead:
      "I'm Oscar Martínez, a senior software engineer with 8+ years building web and mobile apps used by millions — Spin by OXXO, Aeroméxico. Specialized in React Native, React, Node.js, .NET, AWS and AI-augmented workflows, I help businesses take their product from idea to production.",
    hero_cta1: "Let's talk about your project →",
    hero_cta2: "See experience",
    meta1: "years of experience",
    meta2b: "Millions",
    meta2: "of users reached",
    meta3: "mobile · web · cloud · AI",
    exp_eyebrow: "// selected work",
    exp_head: "Products I've helped build.",
    xp_via: "via",
    tab_biz: "Business",
    tab_tech: "Technical",
    xp1_when: "2025 — 2026",
    ...
    xp1_tech:
      "React Native with TypeScript, integrating microservices and backend APIs across a distributed architecture. Strict code standards, performance optimization and clean architecture required for enterprise-level reliability.",
    xp2_when: "2025 · Freelance",
    xp2_biz:
      "A contracting company was running its whole operation on spreadsheets — cities, materials and meter data, scattered and manual. I built them a custom ERP from scratch that centralizes it into one place, so their team stops losing hours to manual tracking and works from a single source of truth.",
    xp2_tech:
      ".NET 7 backend with SQL Server and a mobile-first React PWA (Tailwind). JWT authentication, AWS S3 storage, and admin modules for cities, materials and meters. Deployed to QA and production on Ubuntu with Nginx, HTTPS (Let's Encrypt) and CI/CD pipelines.",
    xp3_when: "2023 — 2025",
    xp3_biz:
      "Spin Premia and Spin by OXXO are fintech apps used by millions across Mexico — loyalty, payments and rewards. I helped build and maintain the features that keep those apps dependable for a massive daily user base.",
    xp3_tech:
      "React Native, Redux and TypeScript, with TDD in Jest at 85%+ coverage per pull request. QA and production releases managed through Firebase, following SCRUM.",
    xp4_when: "2021 — 2023",
    xp4_biz:
      "For Sumitomo Corporation, a global enterprise, I helped deliver internal web applications that streamline how their teams work — built fully remotely alongside US stakeholders.",
    xp4_tech:
      "React, Redux, TypeScript and DevExpress on the front, SQL Server services on the back, with TDD in Jest. Deployed to Microsoft Azure, collaborating in Agile teams across time zones.",
    xp5_when: "2019 — 2021",
    xp5_biz:
      "Terminal Logistics moves high volumes of freight, and their operation runs on custom software. I led development of the logistics tools that keep that throughput flowing, day in and day out.",
    xp5_tech:
      "React, React Native, Redux, Node.js and C#/.NET, managing SQL Server and MongoDB databases built for high-throughput logistics operations.",
    serv_eyebrow: "// what I build",
...
function applyLang(l) {
  ...
  document.querySelectorAll("[data-i18n]").forEach((el) => {
    ...
    if (dict[l][k] != null) el.textContent = dict[l][k];
  });
  document.querySelectorAll("[data-i18n-html]").forEach((el) => {
    const k = el.getAttribute("data-i18n-html");
    if (dict[l][k] != null) el.innerHTML = dict[l][k];
  });
  document.querySelectorAll("[data-i18n-aria]").forEach((el) => {
    const k = el.getAttribute("data-i18n-aria");
    if (dict[l][k] != null) el.setAttribute("aria-label", dict[l][k]);
  });
  const md = document.querySelector('meta[name="description"]');
  if (md && dict[l].meta_desc) md.setAttribute("content", dict[l].meta_desc);
  document.getElementById("lang").textContent = l === "es" ? "EN" : "ES";
  document.title =
    l === "es"
      ? "Oscar Martínez — Ingeniero de Software Senior"
      : "Oscar Martínez — Senior Mobile & Fullstack Engineer";
}
...
document.getElementById("years-exp").textContent =
